...
\def\myauthor{Yicong Zheng$^{1,2}$, Xiaonan L. Liu$^{1,2,3}$, Satoru Nishiyama$^{4,5}$, Charan Ranganath$^{1,2}$, and Randall C. O'Reilly$^{1,2,6}$\\
